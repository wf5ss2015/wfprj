...
?>
<article>
	<h1>Veranstaltung - Student </h1>
	<p>Hier können Sie einen Studenten zu den Teilnehmern einer Veranstaltung hinzufügen.</p>
	...
	<tr><th></th><th></th></tr>
	<!-- Zur Auswahl des Users, der hinzugefügt werden soll, eine Liste mit allen Studenten -->
	<tr>
		<th>Student </th><th><select name="user">
				 <?php
					if ($this->user_list) {
	...
	<input type="hidden" name="personentyp" value="student">
	<p><br>
			<?php
