...
?>
<article>
	<h1>Ein Nutzerkonto für <b>"Mitarbeiter"</b> anlegen</h1>
	</br>			
	</br>
	...
	function generateUserName(){
		if(document.form.username.value=='' && document.form.fname.value!='' && document.form.lname.value!='') {
				 var username = document.form.fname.value.substr(0,2) + document.form.lname.value.substr(0,3);
	...
	function checkMe() {
		if (confirm("Mitarbeiter jetzt anlegen?")) {
			return true;
		} else {
			return false;
		}
     ...
     <form action="index.php?url=Employee/anlageMitarbeiter" name="form" method="post">
		<table>
			...
			<tr>
              ...
              <td>
			  <select name="land" required="required" style="max-width:45%" >
			...
			<tr>
              ...
              <td><input name="plz" required="required" type="text" value = "" pattern="\d{5,5}"></td>
			</tr>
			<?php//Email?>
			<tr>
			...
			<tr>
			  <td><label style="font-size: 100%; font-style: italic">(Falls Nutzer bereits vorhanden, </br> wird eine fortlaufende numerische </br> Ziffer angehängt!)</label></td>
			</tr>
			<?php//Passwort?>
			<tr>
		...
		<br>
		<input class="button" value="Mitarbeiter anlegen" type="submit" onClick="return checkMe()">
     </form>
