     ...
     <form action="index.php?url=Employee/anlageStudent" name="form"  method="post">
		<table>
			...
			<tr>
              ...
              <td>
			  <select name="land" required="required" style="max-width:34%" >
			...
			<tr>
              ...
              <td><select  name="studiengang" style="max-width:34%"
		...
		<br>
		<input class="button" value="Studenten anlegen" type="submit" onClick="return checkMe()">
     </form>
