...
(
	...
	`stg_kurztext` VARCHAR(45) NOT NULL ,
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Dozent_berechtigtFuer_Veranstaltung` ;

CREATE  TABLE `Dozent_berechtigtFuer_Veranstaltung` 
(
	`veranst_ID` INT NOT NULL,
	`dozent_nutzer_name` VARCHAR(45) NOT NULL,
	PRIMARY KEY (`veranst_ID`, `dozent_nutzer_name`),
